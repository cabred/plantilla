	...
	<!-- start slider -->
         ...
         <div class="slider_container">
               ...
               <img src="images/slider1.jpg" class="img-responsive" alt=""/>
                ...
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <!-- Text title -->
                        <h1 class="title">Variedad<br>De Prendas</h1>
                        <!-- /Text title -->
            ...
            <div class="slide">
               <img src="images/slider2.jpg" class="img-responsive" alt=""/>
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <h1 class="title">Maquillajes<br>Accesorios</h1>
                       	<div class="button"><a href="#">See Details</a></div>
                    </div>
                </div>
            </div>
            ...
            <div class="slide">
				<img src="images/slider3.jpg" class="img-responsive" alt=""/>
				 <div class="slide_content">
					 <div class="slide_content_wrap">
						 <h1 class="title">Sistema De<br>Apartado</h1>
							<div class="button"><a href="#">See Details</a></div>
					 </div>
				 </div>
			 </div>
	  ...
	  <div class="main">
		<div class="content-top">
			<h2>Lipsticks</h2>
			<p>gran variedad y calidad garantizada</p>
				<ul id="flexiselDemo3">
		...
		<h3>No te quedes sin los tuyos</h3>
			<script type="text/javascript">
		...
		<div class="footer">
			<div class="container">
				...
				<div class="row footer_bottom">
				    <div class="copy">
			           <p>© 2022 by <a href="https://www.instagram.com/by_cabred/" target="_blank">CABRED</a></p>
		            </div>
